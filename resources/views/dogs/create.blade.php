                    ...
                    <form action="{{ route('dogs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Ej. Toby" />
                            ...
                            <div>
                                ...
                                <x-text-input id="age" class="block w-full" type="number" name="age" :value="old('age')" placeholder="Ej. 2" />
                        ...
                        <div class="flex items-center justify-end mt-8 pt-6 border-t border-brand-50">
                            ...
                            <button type="submit" class="inline-flex items-center justify-center px-5 py-2.5 bg-brand-200 hover:bg-brand-500 text-brand-900 hover:text-white font-bold text-xs uppercase tracking-widest rounded-2xl hover:scale-[1.02] active:scale-[0.98] shadow-md transition-all duration-150">
                                {{ __('Guardar Mascota') }}
                            </button>
                        </div>
                    </form>
